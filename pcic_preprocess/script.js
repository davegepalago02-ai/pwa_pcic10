...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderTable(data) {
        ...
        // Define exact columns to show. We'll add 'Checkbox' at index 0
        const targetColumns = [
            'Checkbox', 'No.', 'FarmersID', 'RSBSAID', 'Farmer Name',
            'MunFarmer', 'BrgyFarmer', 'StFarmer', 'InsuranceLine', 'CropType', 'Class', 'AmountCover'
        ];
    ...
    function updateDashboard() {
        ...
        const noFiltersActive = !isSearchActive && !isInsuranceActive && !isClassActive && !isCropActive;
