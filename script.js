...
// === VERSION CONTROL ===
const APP_VERSION = "1.3.2"; // Single source of truth
// =======================
...
function resizeCanvas() {
    ...
    sigs.forEach(item => {
        ...
        if (item.pad) {
            ...
            if (data) {
                // Attempt to restore signature data
                // Note: If the aspect ratio changes significantly, it might look stretched
